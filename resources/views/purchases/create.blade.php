...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mb-1">Create Purchase</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            placeholder="Contoh: PUR-2026-0001"
                            required
                        >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        >
                            <option
                                value="GENERAL"
                                @selected(old('purchase_type', 'GENERAL') === 'GENERAL')
                            >
                                GENERAL
                            </option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        >
                            ...
                            @foreach ($workOrders as $workOrder)
                                <option
                                    value="{{ $workOrder->id }}"
                                    @selected(old('work_order_id') == $workOrder->id)
                                >
                        ...
                        <small class="text-muted">
                            Wajib dipilih jika Purchase Type = WORK ORDER.
                        </small>
                    </div>
